...
В обычных языках программирования принято следовать внешним парадигмам или строить язык как отдельную сущность. RTS же построен на собственной отдельной парадигме [FDS](https://realtime.su/en/paradigm)(Free Data Structures). Поэтому получается двухуровневая структура от парадигмы до языка.

FDS уделяет большое внимание натурофилосовской части и утверждает направления развития в соответсвии с окружиющим нас миром. Следуя парадигме, RTS предоставляет минимальный и мощный язык программирования для свободного написания любых структур данных.
