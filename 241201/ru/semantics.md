...
- В языке присутствуют [**примитивные типы**](./primitives#Примитивы) данных, а также определённый [**минимальный набор**](./methods#методы) функционала;
- Примитивы имеют «природное» [**поведение**](./primitives#Поведение) - чётко определённое и стабильное для конкретных ситуаций;
...
- Реализовано [**владение**](./ownership) структурами или использование **ссылок** на них;
